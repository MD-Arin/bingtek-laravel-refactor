...
class DashboardController extends Controller {
    ...
    public function updateOfficeSpace(Request $request) {
        ...
        if (Auth::check()) {
            if (Input::get('homeOfficeH1') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-h1']])->update(['body' => Input::get('homeOfficeH1')]);
                if (Input::get('homeOfficeH2') != null) {
                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-h2']])->update(['body' => Input::get('homeOfficeH2')]);
                    if (Input::get('homeOffice1li1') != null) {
                        $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-1']])->update(['body' => Input::get('homeOffice1li1')]);
                        if (Input::get('homeOffice1li2') != null) {
                            $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-2']])->update(['body' => Input::get('homeOffice1li2')]);
                            if (Input::get('homeOffice1li3') != null) {
                                ...
                                if (Input::get('homeOffice1li4') != null) {
                                    ...
                                    if ($request->hasFile('homeOfficeImg')) {
                                        $img = $request->file('homeOfficeImg');
                                        $filename = time() . '.' . $img->getClientOriginalExtension();
                                        $location = public_path('img/production/' . $filename);
                                        $dataLocation = 'img/production/' . $filename;
                                        Image::make($img)->save($location);

                                        $content->where([['pages_id', '=', '1'], ['section', '=', '5-2-img']])->update(['body' => $dataLocation]);

                                        if (Input::get('homeOffice3H1') != null) {
                                            $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-h1']])->update(['body' => Input::get('homeOffice3H1')]);
                                            if (Input::get('homeOffice3P') != null) {
                                                $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-p']])->update(['body' => Input::get('homeOffice3P')]);
                                                if (Input::get('4-office-submit')) {
                                                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-link']])->update(['body' => Input::get('homeOffice3link')]);
                                                }
                                            }
                                        }
                                    }
            ...
            } elseif (Input::get('homeOfficeH2') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-h2']])->update(['body' => Input::get('homeOfficeH2')]);
                if (Input::get('homeOffice1li1') != null) {
                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-1']])->update(['body' => Input::get('homeOffice1li1')]);
                    if (Input::get('homeOffice1li2') != null) {
            ...
            } elseif (Input::get('homeOffice1li1') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-1']])->update(['body' => Input::get('homeOffice1li1')]);
                if (Input::get('homeOffice1li2') != null) {
                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-2']])->update(['body' => Input::get('homeOffice1li2')]);
                    if (Input::get('homeOffice1li3') != null) {
            ...
            } elseif (Input::get('homeOffice1li2') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-2']])->update(['body' => Input::get('homeOffice1li2')]);
                if (Input::get('homeOffice1li3') != null) {
                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-3']])->update(['body' => Input::get('homeOffice1li3')]);
                    if (Input::get('homeOffice1li4') != null) {
            ...
            } elseif (Input::get('homeOffice1li4') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-1-li-4']])->update(['body' => Input::get('homeOffice1li4')]);
                if ($request->hasFile('homeOfficeImg')) {
                    $img = $request->file('homeOfficeImg');
                    $filename = time() . '.' . $img->getClientOriginalExtension();
            ...
            } elseif ($request->hasFile('homeOfficeImg')) {
                $img = $request->file('homeOfficeImg');
                $filename = time() . '.' . $img->getClientOriginalExtension();
                $location = public_path('img/production/' . $filename);
                $dataLocation = 'img/production/' . $filename;
            ...
            } elseif (Input::get('homeOffice3H1') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-h1']])->update(['body' => Input::get('homeOffice3H1')]);
                if (Input::get('homeOffice3P') != null) {
                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-p']])->update(['body' => Input::get('homeOffice3P')]);
                    if (Input::get('4-office-submit')) {
            ...
            } elseif (Input::get('homeOffice3P') != null) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-p']])->update(['body' => Input::get('homeOffice3P')]);
                if (Input::get('4-office-submit')) {
                    $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-link']])->update(['body' => Input::get('homeOffice3link')]);
                }
            } elseif (Input::get('4-office-submit')) {
                $content->where([['pages_id', '=', '1'], ['section', '=', '5-3-link']])->update(['body' => Input::get('homeOffice3link')]);
            }
            return redirect('/dashboard');
        }
