...
<div class="container-fluid">
    ...
    <div class="row">
        <h3 class="text-center">Edit Accomplishments</h3>
        <hr class="underline">
        <div class="container-fluid">
            <div class="row">
                <form class="form-group" action="/dash-about/aboutMilestones" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input class="form-control" type="text" name="1-milestone-h1-1" placeholder="Accomplishments Main Heading">
                    <hr>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <input class="btn btn-primary" type="file" name="1-milestone-img-1" >
                        <br>
                        <input class="form-control" type="number"  name="1-milestone-year-1" placeholder="Year Of Accomplishment">
                        <br>
                        <input class="form-control" type="text" name="1-milestone-accomplishment-1" placeholder="Accomplishment">
                        <br>
                        <textarea class="form-control" rows="8" cols="20" name="1-milestone-body-1" placeholder="Accomplishment Body/ Story"></textarea>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <input class="btn btn-primary" type="file" name="1-milestone-img-2" >
                        <br>
                        <input class="form-control" type="number" name="1-milestone-year-2" placeholder="Year Of Accomplishment">
                        <br>
